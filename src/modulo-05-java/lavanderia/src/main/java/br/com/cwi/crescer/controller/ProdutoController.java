...
public class ProdutoController {
	...
	public String buscarProdutos(@PathVariable("id") Long id) {
		JSONArray produtoArray = new JSONArray();
		for (ProdutoDTO produtoDTO : produtoService.listByServico(id)) {
			JSONObject userJSON = new JSONObject();
			userJSON.put("id", produtoDTO.getId());
			userJSON.put("idMaterial", produtoDTO.getIdMaterial());
			userJSON.put("materialDescricao", produtoDTO.getMaterialDescricao());
			produtoArray.put(userJSON);
		}
